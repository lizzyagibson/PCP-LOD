function [L, S, loss] = pcp_lod_nn (D, lambda, mu, Delta)
%
...
for i = 1:MAX_ITER
    ...
    L2_new = L2_opt1 .* (D>=Delta) + ...
             L2_opt2 .* (D<Delta & L2+S2>=0 & L2+S2<=Delta) + ...
             L2_opt3 .* (D<Delta & L2+S2>Delta) + ...
             L2_opt4 .* (D<Delta & L2+S2<0);
    ...
    S2 = S2_opt1 .* (D>=Delta) + ...
         S2_opt2 .* (D<Delta & L2+S2>=0 & L2+S2<=Delta) + ...
         S2_opt3 .* (D<Delta & L2+S2>Delta) + ...
         S2_opt4 .* (D<Delta & L2+S2<0);
