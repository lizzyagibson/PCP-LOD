...
[L,S] = pcp_lod(X,4/sqrt(m),10, delta50); 
[Lnn, Snn, lossnn] = pcp_lod_nn(X, 1/sqrt(m), 10, delta50); 

% X is out dataset, set lambda and mu

% save('../LOD_demo_output/lowrank_lod50.mat', 'L')
% save('../LOD_demo_output/sparse_lod50.mat', 'S')
% 
...
% saveas(gcf,'../../IMAGES/fig1_lod_50.png')
...
% set(gca,'XTick',1:size(L,2));
% set(gca,'XTickLabels',speciesLabels);
% saveas(gcf,'../../IMAGES/fig2_lod_50.png')
