...
filename = '/Users/lizzy/Principle.Component.Pursuit/Below_LOD/R/BLOD_airpol_data/mix_data_lod_30.csv';
delimiter = ',';
startRow = 2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
delta30 = [0.03221, 0, 0.0019, 0.4148542, 0, 0.0209, 0.0015, 1e-04, ...
    0.0019, 0.04121, 0.0253, 0, 8e-04, 0.0035, 0.50335, 0, 0.0402, ...
    0.0021, 0.0011, 0.0057]

%[L,S] = constrained_completion(X,Omega,2000,1e-8,1e-8,1,lambda,lambda,0,0,0,0,0,0); 
[L,S] = pcp_lod(X,4/sqrt(m),10, delta30); 
% X is out dataset, set lambda and mu

save('../LOD_demo_output/lowrank_lod30.mat', 'L')
save('../LOD_demo_output/sparse_lod30.mat', 'S')
...
saveas(gcf,'../../IMAGES/fig1_lod_30.png')
...
set(gca,'XTick',1:size(L,2));
set(gca,'XTickLabels',speciesLabels);
saveas(gcf,'../../IMAGES/fig2_lod_30.png')
