...
results_0  <- lod_pcp(as.matrix(mixture_data), 4/sqrt(m), 10, 0)
results_10 <- lod_pcp(mix_data_lod_10,         4/sqrt(m), 10, delta10)
results_20 <- lod_pcp(mix_data_lod_20,         4/sqrt(m), 10, delta20)
results_30 <- lod_pcp(mix_data_lod_30,         4/sqrt(m), 10, delta30)
results_40 <- lod_pcp(mix_data_lod_40,         4/sqrt(m), 10, delta40)
results_50 <- lod_pcp(mix_data_lod_50,         4/sqrt(m), 10, delta50)
