---
title: "Sqrt(2): Increasing LOD in NHANES POPs"
author: "Lizzy Gibson"
date: "2/1/2020"
output: 
  html_document:
...
3. Run origina PCP (with LOD/sqrt(2) imputed) on all 5 <LOD datasets, save L and S matrices from each.
4. Evaluate relative error -- compare results from <LOD datasets with PCP-LOD and original (imputed with zero).
