...
norm(nn_l_above_blod_20 - l_above_blod_20, "F")
norm(nn_s_above_blod_20 - s_above_blod_20, "F")
...
nn_less_diff_0 <- as_tibble(cbind(
      lod0 = norm((blod_0 - nn_l_blod_0_0 - nn_s_blod_0_0), type = "F"), #/norm((blod_0), type = "F"),
      lod10 = norm((blod_10 - nn_l_blod_10_0 - nn_s_blod_10_0), type = "F")/norm((blod_10), type = "F"),
      lod20 = norm((blod_20 - nn_l_blod_20_0 - nn_s_blod_20_0), type = "F")/norm((blod_20), type = "F"),
      lod30 = norm((blod_30 - nn_l_blod_30_0 - nn_s_blod_30_0), type = "F")/norm((blod_30), type = "F"),
      lod40 = norm((blod_40 - nn_l_blod_40_0 - nn_s_blod_40_0), type = "F")/norm((blod_40), type = "F"),
      lod50 = norm((blod_50 - nn_l_blod_50_0 - nn_s_blod_50_0), type = "F")/norm((blod_50), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Values = "< LOD")
```

```{r}
nn_l_above_blod_0_0 <- as.matrix((!tf_lod_0)*nn_L_lod0_0)
nn_s_above_blod_0_0 <- as.matrix((!tf_lod_0)*nn_S_lod0_0)

nn_l_above_blod_10_0 <- as.matrix((!tf_lod_10)*nn_L_lod10_0)
nn_s_above_blod_10_0 <- as.matrix((!tf_lod_10)*nn_S_lod10_0)

nn_l_above_blod_20_0 <- as.matrix((!tf_lod_20)*nn_L_lod20_0)
nn_s_above_blod_20_0 <- as.matrix((!tf_lod_20)*nn_S_lod20_0)

nn_l_above_blod_30_0 <- as.matrix((!tf_lod_30)*nn_L_lod30_0)
nn_s_above_blod_30_0 <- as.matrix((!tf_lod_30)*nn_S_lod30_0)

nn_l_above_blod_40_0 <- as.matrix((!tf_lod_40)*nn_L_lod40_0)
nn_s_above_blod_40_0 <- as.matrix((!tf_lod_40)*nn_S_lod40_0)

nn_l_above_blod_50_0 <- as.matrix((!tf_lod_50)*nn_L_lod50_0)
nn_s_above_blod_50_0 <- as.matrix((!tf_lod_50)*nn_S_lod50_0)
```

```{r}
#divide by true values
nn_above_diff_0 <- as_tibble(cbind(
  lod0  = norm((mix  - nn_l_above_blod_0_0  - nn_s_above_blod_0_0),  type = "F")/norm(mix,  type = "F"),
  lod10 = norm((mix_data_lod_10_0 - nn_l_above_blod_10_0 - nn_s_above_blod_10_0), type = "F")/norm(mix_data_lod_10_0, type = "F"),
  lod20 = norm((mix_data_lod_20_0 - nn_l_above_blod_20_0 - nn_s_above_blod_20_0), type = "F")/norm(mix_data_lod_20_0, type = "F"),
  lod30 = norm((mix_data_lod_30_0 - nn_l_above_blod_30_0 - nn_s_above_blod_30_0), type = "F")/norm(mix_data_lod_30_0, type = "F"),
  lod40 = norm((mix_data_lod_40_0 - nn_l_above_blod_40_0 - nn_s_above_blod_40_0), type = "F")/norm(mix_data_lod_40_0, type = "F"),
  lod50 = norm((mix_data_lod_50_0 - nn_l_above_blod_50_0 - nn_s_above_blod_50_0), type = "F")/norm(mix_data_lod_50_0, type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Values = "> LOD")
...
nn_less_diff_sqrt2 <- as_tibble(
  cbind(lod0  = norm((blod_0  - nn_L_blod_0_sqrt2  - nn_S_blod_0_sqrt2),  type = "F"), #/norm((blod_0), type = "F"),
        lod10 = norm((blod_10 - nn_L_blod_10_sqrt2 - nn_S_blod_10_sqrt2), type = "F")/norm((blod_10), type = "F"),
        lod20 = norm((blod_20 - nn_L_blod_20_sqrt2 - nn_S_blod_20_sqrt2), type = "F")/norm((blod_20), type = "F"),
        lod30 = norm((blod_30 - nn_L_blod_30_sqrt2 - nn_S_blod_30_sqrt2), type = "F")/norm((blod_30), type = "F"),
        lod40 = norm((blod_40 - nn_L_blod_40_sqrt2 - nn_S_blod_40_sqrt2), type = "F")/norm((blod_40), type = "F"),
        lod50 = norm((blod_50 - nn_L_blod_50_sqrt2 - nn_S_blod_50_sqrt2), type = "F")/norm((blod_50), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Values = "< LOD")
```
...
nn_L_above_blod_10_sqrt2 <- as.matrix((!tf_lod_10)*nn_L_lod10_sqrt2)
nn_S_above_blod_10_sqrt2 <- as.matrix((!tf_lod_10)*nn_S_lod10_sqrt2)

nn_L_above_blod_20_sqrt2 <- as.matrix((!tf_lod_20)*nn_L_lod20_sqrt2)
nn_S_above_blod_20_sqrt2 <- as.matrix((!tf_lod_20)*nn_S_lod20_sqrt2)

nn_L_above_blod_30_sqrt2 <- as.matrix((!tf_lod_30)*nn_L_lod30_sqrt2)
nn_S_above_blod_30_sqrt2 <- as.matrix((!tf_lod_30)*nn_S_lod30_sqrt2)

nn_L_above_blod_40_sqrt2 <- as.matrix((!tf_lod_40)*nn_L_lod40_sqrt2)
nn_S_above_blod_40_sqrt2 <- as.matrix((!tf_lod_40)*nn_S_lod40_sqrt2)

nn_L_above_blod_50_sqrt2 <- as.matrix((!tf_lod_50)*nn_L_lod50_sqrt2)
nn_S_above_blod_50_sqrt2 <- as.matrix((!tf_lod_50)*nn_S_lod50_sqrt2)
```

```{r}
#divide by true values
nn_above_diff_sqrt2 <- as_tibble(cbind(
  lod0  = norm((mix  - nn_L_above_blod_0_sqrt2  - nn_S_above_blod_0_sqrt2),  type = "F")/norm(mix,  type = "F"),
  lod10 = norm((mix_data_lod_10_0 - nn_L_above_blod_10_sqrt2 - nn_S_above_blod_10_sqrt2), type = "F")/norm(mix_data_lod_10_0, type = "F"),
  lod20 = norm((mix_data_lod_20_0 - nn_L_above_blod_20_sqrt2 - nn_S_above_blod_20_sqrt2), type = "F")/norm(mix_data_lod_20_0, type = "F"),
  lod30 = norm((mix_data_lod_30_0 - nn_L_above_blod_30_sqrt2 - nn_S_above_blod_30_sqrt2), type = "F")/norm(mix_data_lod_30_0, type = "F"),
  lod40 = norm((mix_data_lod_40_0 - nn_L_above_blod_40_sqrt2 - nn_S_above_blod_40_sqrt2), type = "F")/norm(mix_data_lod_40_0, type = "F"),
  lod50 = norm((mix_data_lod_50_0 - nn_L_above_blod_50_sqrt2 - nn_S_above_blod_50_sqrt2), type = "F")/norm(mix_data_lod_50_0, type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Values = "> LOD")
