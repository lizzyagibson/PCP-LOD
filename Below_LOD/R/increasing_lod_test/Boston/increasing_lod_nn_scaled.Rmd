...
# cor(nn_V_lod0_0, nn_V_lod10_0)
# cor(nn_V_lod0_0, nn_V_lod20_0)
# cor(nn_V_lod0_0, nn_V_lod30_0)
# cor(nn_V_lod0_0, nn_V_lod40_0)
# cor(nn_V_lod0_0, nn_V_lod50_0)

# Hack -- Flip
nn_V_lod30_0[,3] <- -nn_V_lod30_0[,3]
nn_V_lod30_0[,4] <- -nn_V_lod30_0[,4]
nn_V_lod40_0[,3] <- -nn_V_lod40_0[,3]
nn_V_lod40_0[,4] <- -nn_V_lod40_0[,4]
nn_V_lod40_0[,5] <- -nn_V_lod40_0[,5]
nn_V_lod50_0[,3] <- -nn_V_lod50_0[,3]
nn_V_lod50_0[,4] <- -nn_V_lod50_0[,4]
nn_V_lod50_0[,5] <- -nn_V_lod50_0[,5]
...
cor(nn_V_lod0_sqrt2, nn_V_lod10_sqrt2)
cor(nn_V_lod0_sqrt2, nn_V_lod20_sqrt2)
cor(nn_V_lod0_sqrt2, nn_V_lod30_sqrt2)
cor(nn_V_lod0_sqrt2, nn_V_lod40_sqrt2)
cor(nn_V_lod0_sqrt2, nn_V_lod50_sqrt2)

# Hack -- Flip
nn_V_lod30_sqrt2[,3] <- -nn_V_lod30_sqrt2[,3]
nn_V_lod30_sqrt2[,4] <- -nn_V_lod30_sqrt2[,4]
nn_V_lod40_sqrt2[,3] <- -nn_V_lod40_sqrt2[,3]
nn_V_lod50_sqrt2[,3] <- -nn_V_lod50_sqrt2[,3]
nn_V_lod50_sqrt2[,4] <- -nn_V_lod50_sqrt2[,4]


nn_V_diff_sqrt2 <- as_tibble(cbind(
      lod0 =norm((nn_V_lod0_sqrt2 - nn_V_lod0_sqrt2), type = "F")/norm((nn_V_lod0_sqrt2), type = "F"),
...
```{r}
nn_u_lod0_0  <-  svd(nn_L_lod0_0)$u[,1:5]
nn_u_lod10_0 <- svd(nn_L_lod10_0)$u[,1:5]
nn_u_lod20_0 <- svd(nn_L_lod20_0)$u[,1:5]
nn_u_lod30_0 <- svd(nn_L_lod30_0)$u[,1:5]
nn_u_lod40_0 <- svd(nn_L_lod40_0)$u[,1:5]
nn_u_lod50_0 <- svd(nn_L_lod50_0)$u[,1:5]

# Hack -- Flip
nn_u_lod30_0[,4] <- -nn_u_lod30_0[,4]
nn_u_lod30_0[,3] <- -nn_u_lod30_0[,3]
nn_u_lod40_0[,3] <- -nn_u_lod40_0[,3]
nn_u_lod40_0[,4] <- -nn_u_lod40_0[,4]
nn_u_lod40_0[,5] <- -nn_u_lod40_0[,5]
nn_u_lod50_0[,3] <- -nn_u_lod50_0[,3]
nn_u_lod50_0[,4] <- -nn_u_lod50_0[,4]
nn_u_lod50_0[,5] <- -nn_u_lod50_0[,5]
...
```{r}
nn_u_lod0_sqrt2  <-  svd(nn_L_lod0_sqrt2)$u[,1:5]
nn_u_lod10_sqrt2 <- svd(nn_L_lod10_sqrt2)$u[,1:5]
nn_u_lod20_sqrt2 <- svd(nn_L_lod20_sqrt2)$u[,1:5]
nn_u_lod30_sqrt2 <- svd(nn_L_lod30_sqrt2)$u[,1:5]
nn_u_lod40_sqrt2 <- svd(nn_L_lod40_sqrt2)$u[,1:5]
nn_u_lod50_sqrt2 <- svd(nn_L_lod50_sqrt2)$u[,1:5]
...
```{r}
nn_d_lod0_0  <- svd(nn_L_lod0_0)$d[1:5]
nn_d_lod10_0 <- svd(nn_L_lod10_0)$d[1:5]
nn_d_lod20_0 <- svd(nn_L_lod20_0)$d[1:5]
nn_d_lod30_0 <- svd(nn_L_lod30_0)$d[1:5]
nn_d_lod40_0 <- svd(nn_L_lod40_0)$d[1:5]
nn_d_lod50_0 <- svd(nn_L_lod50_0)$d[1:5]
...
```{r}
nn_d_lod0_sqrt2  <- svd(nn_L_lod0_sqrt2)$d[1:5]
nn_d_lod10_sqrt2 <- svd(nn_L_lod10_sqrt2)$d[1:5]
nn_d_lod20_sqrt2 <- svd(nn_L_lod20_sqrt2)$d[1:5]
nn_d_lod30_sqrt2 <- svd(nn_L_lod30_sqrt2)$d[1:5]
nn_d_lod40_sqrt2 <- svd(nn_L_lod40_sqrt2)$d[1:5]
nn_d_lod50_sqrt2 <- svd(nn_L_lod50_sqrt2)$d[1:5]
