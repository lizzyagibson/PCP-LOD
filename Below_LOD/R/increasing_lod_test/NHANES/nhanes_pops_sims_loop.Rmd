...
sim_all <- sim_all %>% 
  mutate(L_lod0  = map(results_0[[1]][1], as_tibble),
         S_lod0  = map(results_0[[1]][2], as_tibble),
         L_lod10 = map(results_10[[1]][1], as_tibble),
         S_lod10 = map(results_10[[1]][2], as_tibble),
         L_lod20 = map(results_20[[1]][1], as_tibble),
         S_lod20 = map(results_20[[1]][2], as_tibble),
         L_lod30 = map(results_30[[1]][1], as_tibble),
         S_lod30 = map(results_30[[1]][2], as_tibble),
         L_lod40 = map(results_40[[1]][1], as_tibble),
         S_lod40 = map(results_40[[1]][2], as_tibble),
         L_lod50 = map(results_50[[1]][1], as_tibble),
         S_lod50 = map(results_50[[1]][2], as_tibble))

sim_all <- sim_all %>% 
  mutate(L_lod0_0  = map(results_0_0[[1]][1], as_tibble),
         S_lod0_0  = map(results_0_0[[1]][2], as_tibble),
         L_lod10_0 = map(results_10_0[[1]][1], as_tibble),
         S_lod10_0 = map(results_10_0[[1]][2], as_tibble),
         L_lod20_0 = map(results_20_0[[1]][1], as_tibble),
         S_lod20_0 = map(results_20_0[[1]][2], as_tibble),
         L_lod30_0 = map(results_30_0[[1]][1], as_tibble),
         S_lod30_0 = map(results_30_0[[1]][2], as_tibble),
         L_lod40_0 = map(results_40_0[[1]][1], as_tibble),
         S_lod40_0 = map(results_40_0[[1]][2], as_tibble),
         L_lod50_0 = map(results_50_0[[1]][1], as_tibble),
         S_lod50_0 = map(results_50_0[[1]][2], as_tibble))

sim_all <- sim_all %>% 
  mutate(L_lod0_sqrt2  = map(results_0_sqrt2[[1]][1], as_tibble),
         S_lod0_sqrt2  = map(results_0_sqrt2[[1]][2], as_tibble),
         L_lod10_sqrt2 = map(results_10_sqrt2[[1]][1], as_tibble),
         S_lod10_sqrt2 = map(results_10_sqrt2[[1]][2], as_tibble),
         L_lod20_sqrt2 = map(results_20_sqrt2[[1]][1], as_tibble),
         S_lod20_sqrt2 = map(results_20_sqrt2[[1]][2], as_tibble),
         L_lod30_sqrt2 = map(results_30_sqrt2[[1]][1], as_tibble),
         S_lod30_sqrt2 = map(results_30_sqrt2[[1]][2], as_tibble),
         L_lod40_sqrt2 = map(results_40_sqrt2[[1]][1], as_tibble),
         S_lod40_sqrt2 = map(results_40_sqrt2[[1]][2], as_tibble),
         L_lod50_sqrt2 = map(results_50_sqrt2[[1]][1], as_tibble),
         S_lod50_sqrt2 = map(results_50_sqrt2[[1]][2], as_tibble))

sim_all <- sim_all %>% 
  mutate(L_lod0_2  = map(results_0_2[[1]][1], as_tibble),
         S_lod0_2  = map(results_0_2[[1]][2], as_tibble),
         L_lod10_2 = map(results_10_2[[1]][1], as_tibble),
         S_lod10_2 = map(results_10_2[[1]][2], as_tibble),
         L_lod20_2 = map(results_20_2[[1]][1], as_tibble),
         S_lod20_2 = map(results_20_2[[1]][2], as_tibble),
         L_lod30_2 = map(results_30_2[[1]][1], as_tibble),
         S_lod30_2 = map(results_30_2[[1]][2], as_tibble),
         L_lod40_2 = map(results_40_2[[1]][1], as_tibble),
         S_lod40_2 = map(results_40_2[[1]][2], as_tibble),
         L_lod50_2 = map(results_50_2[[1]][1], as_tibble),
         S_lod50_2 = map(results_50_2[[1]][2], as_tibble))

sim_all <- sim_all %>% 
  mutate(L_lod0_nnS  = map(results_0_nnS[[1]][1], as_tibble),
         S_lod0_nnS  = map(results_0_nnS[[1]][2], as_tibble),
         L_lod10_nnS = map(results_10_nnS[[1]][1], as_tibble),
         S_lod10_nnS = map(results_10_nnS[[1]][2], as_tibble),
         L_lod20_nnS = map(results_20_nnS[[1]][1], as_tibble),
         S_lod20_nnS = map(results_20_nnS[[1]][2], as_tibble),
         L_lod30_nnS = map(results_30_nnS[[1]][1], as_tibble),
         S_lod30_nnS = map(results_30_nnS[[1]][2], as_tibble),
         L_lod40_nnS = map(results_40_nnS[[1]][1], as_tibble),
         S_lod40_nnS = map(results_40_nnS[[1]][2], as_tibble),
         L_lod50_nnS = map(results_50_nnS[[1]][1], as_tibble),
         S_lod50_nnS = map(results_50_nnS[[1]][2], as_tibble))
...
sim_ab <- sim_ab %>% select(grep("blod", colnames(.)))
