...
extract_SVD <- function (L_lod0, L_lod10, L_lod20, L_lod30, L_lod40, L_lod50) {
        ...
        list(v_lod0 = v_lod0, v_lod10 = v_lod10, v_lod20 = v_lod20, v_lod30 = v_lod30, v_lod40 = v_lod40, v_lod50 = v_lod50,
             u_lod0 = u_lod0, u_lod10 = u_lod10, u_lod20 = u_lod20, u_lod30 = u_lod30, u_lod40 = u_lod40, u_lod50 = u_lod50,
             d_lod0 = d_lod0, d_lod10 = d_lod10, d_lod20 = d_lod20, d_lod30 = d_lod30, d_lod40 = d_lod40, d_lod50 = d_lod50)
}

sim_svd <- sim_all %>% 
  mutate(lod_pcp_svd = pmap(list(L_lod0_0, L_lod10_0, L_lod20_0, L_lod30_0, L_lod40_0, L_lod50_0), 
                      function (a,b,c,d,e,f) extract_SVD(a,b,c,d,e,f))) %>% 
  unnest_wider(lod_pcp_svd) %>% 
  rename_at(vars(c(starts_with("v"),starts_with("u"),starts_with("d"))), funs(str_replace(., "0", "0_0"))) %>% 
  mutate(lod_pcp_svd = pmap(list(L_lod0_sqrt2, L_lod10_sqrt2, L_lod20_sqrt2, 
                                 L_lod30_sqrt2, L_lod40_sqrt2, L_lod50_sqrt2), 
                          function (a,b,c,d,e,f) extract_SVD(a,b,c,d,e,f))) %>% 
  unnest_wider(lod_pcp_svd) %>% 
  rename_at(vars(c(starts_with("v"),starts_with("u"),starts_with("d"))), funs(str_replace(., "0", "0_sqrt2"))) %>% 
  mutate(lod_pcp_svd = pmap(list(L_lod0_2, L_lod10_2, L_lod20_2, L_lod30_2, L_lod40_2, L_lod50_2), 
                          function (a,b,c,d,e,f) extract_SVD(a,b,c,d,e,f))) %>% 
  unnest_wider(lod_pcp_svd) %>% 
  rename_at(vars(c(starts_with("v"),starts_with("u"),starts_with("d"))), funs(str_replace(., "0", "0_2"))) %>% 
  mutate(lod_pcp_svd = pmap(list(L_lod0_nnS, L_lod10_nnS, L_lod20_nnS, L_lod30_nnS, L_lod40_nnS, L_lod50_nnS), 
                          function (a,b,c,d,e,f) extract_SVD(a,b,c,d,e,f))) %>% 
  unnest_wider(lod_pcp_svd) %>% 
  rename_at(vars(c(starts_with("v"),starts_with("u"),starts_with("d"))), funs(str_replace(., "0", "0_nnS"))) %>% 
