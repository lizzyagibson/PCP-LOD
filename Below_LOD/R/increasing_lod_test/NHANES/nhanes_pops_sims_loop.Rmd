...
extract <- function (results, number) {
  LS <- results[[number]]
  LS
  }

sim_all <- sim_all %>% 
  mutate(L_lod0 = pmap(list(results_0, 1), function(x,y) extract(x,y)),
         S_lod0 = pmap(list(results_0, 2), function(x,y) extract(x,y)),
         L_lod10 = pmap(list(results_10, 1), function(x,y) extract(x,y)),
         S_lod10 = pmap(list(results_10, 2), function(x,y) extract(x,y)),
         L_lod20 = pmap(list(results_20, 1), function(x,y) extract(x,y)),
         S_lod20 = pmap(list(results_20, 2), function(x,y) extract(x,y)),
         L_lod30 = pmap(list(results_30, 1), function(x,y) extract(x,y)),
         S_lod30 = pmap(list(results_30, 2), function(x,y) extract(x,y)),
         L_lod40 = pmap(list(results_40, 1), function(x,y) extract(x,y)),
         S_lod40 = pmap(list(results_40, 2), function(x,y) extract(x,y)),
         L_lod50 = pmap(list(results_50, 1), function(x,y) extract(x,y)),
         S_lod50 = pmap(list(results_50, 2), function(x,y) extract(x,y)))

sim_all <- sim_all %>% 
  mutate(L_lod0_0 = pmap(list(results_0_0, 1), function(x,y) extract(x,y)),
         S_lod0_0 = pmap(list(results_0_0, 2), function(x,y) extract(x,y)),
         L_lod10_0 = pmap(list(results_10_0, 1), function(x,y) extract(x,y)),
         S_lod10_0 = pmap(list(results_10_0, 2), function(x,y) extract(x,y)),
         L_lod20_0 = pmap(list(results_20_0, 1), function(x,y) extract(x,y)),
         S_lod20_0 = pmap(list(results_20_0, 2), function(x,y) extract(x,y)),
         L_lod30_0 = pmap(list(results_30_0, 1), function(x,y) extract(x,y)),
         S_lod30_0 = pmap(list(results_30_0, 2), function(x,y) extract(x,y)),
         L_lod40_0 = pmap(list(results_40_0, 1), function(x,y) extract(x,y)),
         S_lod40_0 = pmap(list(results_40_0, 2), function(x,y) extract(x,y)),
         L_lod50_0 = pmap(list(results_50_0, 1), function(x,y) extract(x,y)),
         S_lod50_0 = pmap(list(results_50_0, 2), function(x,y) extract(x,y)))

sim_all <- sim_all %>% 
  mutate(L_lod0_sqrt2 = pmap(list(results_0_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod0_sqrt2 = pmap(list(results_0_sqrt2, 2), function(x,y) extract(x,y)),
         L_lod10_sqrt2 = pmap(list(results_10_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod10_sqrt2 = pmap(list(results_10_sqrt2, 2), function(x,y) extract(x,y)),
         L_lod20_sqrt2 = pmap(list(results_20_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod20_sqrt2 = pmap(list(results_20_sqrt2, 2), function(x,y) extract(x,y)),
         L_lod30_sqrt2 = pmap(list(results_30_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod30_sqrt2 = pmap(list(results_30_sqrt2, 2), function(x,y) extract(x,y)),
         L_lod40_sqrt2 = pmap(list(results_40_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod40_sqrt2 = pmap(list(results_40_sqrt2, 2), function(x,y) extract(x,y)),
         L_lod50_sqrt2 = pmap(list(results_50_sqrt2, 1), function(x,y) extract(x,y)),
         S_lod50_sqrt2 = pmap(list(results_50_sqrt2, 2), function(x,y) extract(x,y)))

sim_all <- sim_all %>% 
  mutate(L_lod0_2 = pmap(list(results_0_2, 1), function(x,y) extract(x,y)),
         S_lod0_2 = pmap(list(results_0_2, 2), function(x,y) extract(x,y)),
         L_lod10_2 = pmap(list(results_10_2, 1), function(x,y) extract(x,y)),
         S_lod10_2 = pmap(list(results_10_2, 2), function(x,y) extract(x,y)),
         L_lod20_2 = pmap(list(results_20_2, 1), function(x,y) extract(x,y)),
         S_lod20_2 = pmap(list(results_20_2, 2), function(x,y) extract(x,y)),
         L_lod30_2 = pmap(list(results_30_2, 1), function(x,y) extract(x,y)),
         S_lod30_2 = pmap(list(results_30_2, 2), function(x,y) extract(x,y)),
         L_lod40_2 = pmap(list(results_40_2, 1), function(x,y) extract(x,y)),
         S_lod40_2 = pmap(list(results_40_2, 2), function(x,y) extract(x,y)),
         L_lod50_2 = pmap(list(results_50_2, 1), function(x,y) extract(x,y)),
         S_lod50_2 = pmap(list(results_50_2, 2), function(x,y) extract(x,y)))

sim_all <- sim_all %>% 
  mutate(L_lod0_nnS = pmap(list(results_0_nnS, 1), function(x,y) extract(x,y)),
         S_lod0_nnS = pmap(list(results_0_nnS, 2), function(x,y) extract(x,y)),
         L_lod10_nnS = pmap(list(results_10_nnS, 1), function(x,y) extract(x,y)),
         S_lod10_nnS = pmap(list(results_10_nnS, 2), function(x,y) extract(x,y)),
         L_lod20_nnS = pmap(list(results_20_nnS, 1), function(x,y) extract(x,y)),
         S_lod20_nnS = pmap(list(results_20_nnS, 2), function(x,y) extract(x,y)),
         L_lod30_nnS = pmap(list(results_30_nnS, 1), function(x,y) extract(x,y)),
         S_lod30_nnS = pmap(list(results_30_nnS, 2), function(x,y) extract(x,y)),
         L_lod40_nnS = pmap(list(results_40_nnS, 1), function(x,y) extract(x,y)),
         S_lod40_nnS = pmap(list(results_40_nnS, 2), function(x,y) extract(x,y)),
         L_lod50_nnS = pmap(list(results_50_nnS, 1), function(x,y) extract(x,y)),
         S_lod50_nnS = pmap(list(results_50_nnS, 2), function(x,y) extract(x,y)))
```
