...
filename = '/Users/lizzy/Principle.Component.Pursuit/Below_LOD/R/BLOD_airpol_data/mix_data_lod_40.csv';
delimiter = ',';
startRow = 2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
delta40 = [0.0369, 0, 0.0043, 0.4853918, 0, 0.02368, 0.0019, 3e-04, ...
    0.0025, 0.0477, 0.029, 0, 0.0011, 0.0043, 0.61776, 0, 0.0479, ...
    0.0024, 0.0015, 0.0069];

%[L,S] = constrained_completion(X,Omega,2000,1e-8,1e-8,1,lambda,lambda,0,0,0,0,0,0); 
[L,S] = pcp_lod(X,4/sqrt(m),10, delta40); 
% X is out dataset, set lambda and mu

save('../LOD_demo_output/lowrank_lod40.mat', 'L')
save('../LOD_demo_output/sparse_lod40.mat', 'S')
...
saveas(gcf,'../../IMAGES/fig1_lod_40.png')
...
set(gca,'XTick',1:size(L,2));
set(gca,'XTickLabels',speciesLabels);
saveas(gcf,'../../IMAGES/fig2_lod_40.png')
