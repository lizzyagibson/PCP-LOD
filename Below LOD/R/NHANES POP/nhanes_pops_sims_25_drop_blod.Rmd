...
nhanes <- read_sas(here::here("./Data/studypop_lod.sas7bdat")) %>% 
  clean_names() %>% 
  mutate(lbx074la = ifelse(lbd074lc == 1, NA, lbx074la),
         lbx099la = ifelse(lbd099lc == 1, NA, lbx099la),
         lbx105la = ifelse(lbd105lc == 1, NA, lbx105la),
         lbx118la = ifelse(lbd118lc == 1, NA, lbx118la),
         lbx138la = ifelse(lbd138lc == 1, NA, lbx138la),
         lbx153la = ifelse(lbd153lc == 1, NA, lbx153la),
         lbx156la = ifelse(lbd156lc == 1, NA, lbx156la),
         lbx157la = ifelse(lbd157lc == 1, NA, lbx157la),
         lbx167la = ifelse(lbd167lc == 1, NA, lbx167la),
         lbx170la = ifelse(lbd170lc == 1, NA, lbx170la),
         lbx180la = ifelse(lbd180lc == 1, NA, lbx180la),
         lbx187la = ifelse(lbd187lc == 1, NA, lbx187la),
         lbxd01la = ifelse(lbdd01lc == 1, NA, lbxd01la),
         lbxd03la = ifelse(lbdd03lc == 1, NA, lbxd03la),
         lbxd04la = ifelse(lbdd04lc == 1, NA, lbxd04la),
         lbxd05la = ifelse(lbdd05lc == 1, NA, lbxd05la),
         lbxd07la = ifelse(lbdd07lc == 1, NA, lbxd07la),
         lbxf01la = ifelse(lbdf01lc == 1, NA, lbxf01la),
         lbxf02la = ifelse(lbdf02lc == 1, NA, lbxf02la),
         lbxf03la = ifelse(lbdf03lc == 1, NA, lbxf03la),
         lbxf04la = ifelse(lbdf04lc == 1, NA, lbxf04la),
         lbxf05la = ifelse(lbdf05lc == 1, NA, lbxf05la),
         lbxf06la = ifelse(lbdf06lc == 1, NA, lbxf06la),
         lbxf07la = ifelse(lbdf07lc == 1, NA, lbxf07la),
         lbxf08la = ifelse(lbdf08lc == 1, NA, lbxf08la),
         lbxpcbla = ifelse(lbdpcblc == 1, NA, lbxpcbla),
         lbxtcdla = ifelse(lbdtcdlc == 1, NA, lbxtcdla),
         lbxhxcla = ifelse(lbdhxclc == 1, NA, lbxhxcla),
         lbx189la = ifelse(lbd189lc == 1, NA, lbx189la),
         lbx194la = ifelse(lbd194lc == 1, NA, lbx194la),
         lbx196la = ifelse(lbd196lc == 1, NA, lbx196la),
         lbx199la = ifelse(lbd199lc == 1, NA, lbx199la),
         lbxd02la = ifelse(lbdd02lc == 1, NA, lbxd02la),
         lbxf09la = ifelse(lbdf09lc == 1, NA, lbxf09la))
...
V_lod50_sqrt2[,5] <- -V_lod50_sqrt2[,5]
...
u_lod50_sqrt2[,5] <- -u_lod50_sqrt2[,5]
...
```{r}
cor(pca_0$rotation[,1:5], pca_10$rotation[,1:5])
cor(pca_0$rotation[,1:5], pca_20$rotation[,1:5])
cor(pca_0$rotation[,1:5], pca_30$rotation[,1:5])
cor(pca_0$rotation[,1:5], pca_40$rotation[,1:5])
cor(pca_0$rotation[,1:5], pca_50$rotation[,1:5])

pca_30$rotation[,2:5] <- -pca_30$rotation[,2:5]
pca_40$rotation[,1] <- -pca_40$rotation[,1]
pca_50$rotation[,1] <- -pca_50$rotation[,1]

rotation_norm <- as_tibble(cbind(lod0 = norm((pca_0$rotation[,1:5] - pca_0$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"),
      lod10 = norm((pca_0$rotation[,1:5] - pca_10$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"),
      lod20 = norm((pca_0$rotation[,1:5] - pca_20$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"),
      lod30 = norm((pca_0$rotation[,1:5] - pca_30$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"),
      lod40 = norm((pca_0$rotation[,1:5] - pca_40$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"),
      lod50 = norm((pca_0$rotation[,1:5] - pca_50$rotation[,1:5]), type = "F")/norm((pca_0$rotation[,1:5]), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCA")
```

```{r}
cor(pca_0$x[,1:5], pca_10$x[,1:5])
cor(pca_0$x[,1:5], pca_20$x[,1:5])
cor(pca_0$x[,1:5], pca_30$x[,1:5])
cor(pca_0$x[,1:5], pca_40$x[,1:5])
cor(pca_0$x[,1:5], pca_50$x[,1:5])

pca_30$x[,2:5] <- -pca_30$x[,2:5]
pca_40$x[,1] <- -pca_40$x[,1]
pca_50$x[,1] <- -pca_50$x[,1]

score_norm <- as_tibble(cbind(lod0 = norm((pca_0$x[,1:5] - pca_0$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"),
      lod10 = norm((pca_0$x[,1:5] - pca_10$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"),
      lod20 = norm((pca_0$x[,1:5] - pca_20$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"),
      lod30 = norm((pca_0$x[,1:5] - pca_30$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"),
      lod40 = norm((pca_0$x[,1:5] - pca_40$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"),
      lod50 = norm((pca_0$x[,1:5] - pca_50$x[,1:5]), type = "F")/norm((pca_0$x[,1:5]), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCA")
```

```{r}
sdev_norm <- as_tibble(cbind(lod0 = norm_vec(pca_0$sdev[1:5] - pca_0$sdev[1:5])/norm_vec(pca_0$sdev[1:5]),
      lod10 = norm_vec(pca_0$sdev[1:5] - pca_10$sdev[1:5])/norm_vec(pca_0$sdev[1:5]),
      lod20 = norm_vec(pca_0$sdev[1:5] - pca_20$sdev[1:5])/norm_vec(pca_0$sdev[1:5]),
      lod30 = norm_vec(pca_0$sdev[1:5] - pca_30$sdev[1:5])/norm_vec(pca_0$sdev[1:5]),
      lod40 = norm_vec(pca_0$sdev[1:5] - pca_40$sdev[1:5])/norm_vec(pca_0$sdev[1:5]),
      lod50 = norm_vec(pca_0$sdev[1:5] - pca_50$sdev[1:5])/norm_vec(pca_0$sdev[1:5]))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCA")
```
...
```{r}
cor(pcp_pca_0$rotation[,1:5], pcp_pca_10$rotation[,1:5])
cor(pcp_pca_0$rotation[,1:5], pcp_pca_20$rotation[,1:5])
cor(pcp_pca_0$rotation[,1:5], pcp_pca_30$rotation[,1:5])
cor(pcp_pca_0$rotation[,1:5], pcp_pca_40$rotation[,1:5])
cor(pcp_pca_0$rotation[,1:5], pcp_pca_50$rotation[,1:5])

pcp_pca_30$rotation[,5] <- -pcp_pca_30$rotation[,5]
pcp_pca_40$rotation[,4] <- -pcp_pca_40$rotation[,4]
pcp_pca_50$rotation[,2] <- -pcp_pca_50$rotation[,2]
pcp_pca_50$rotation[,4] <- -pcp_pca_50$rotation[,4]
pcp_pca_50$rotation[,5] <- -pcp_pca_50$rotation[,5]

pcp_rotation_norm <- as_tibble(cbind(
  lod0 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_0$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"),
      lod10 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_10$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"),
      lod20 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_20$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"),
      lod30 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_30$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"),
      lod40 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_40$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"),
      lod50 = norm((pcp_pca_0$rotation[,1:5] - pcp_pca_50$rotation[,1:5]), type = "F")/
    norm((pcp_pca_0$rotation[,1:5]), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCP")
```
...
```{r}
cor(pcp_pca_0$x[,1:5], pcp_pca_10$x[,1:5])
cor(pcp_pca_0$x[,1:5], pcp_pca_20$x[,1:5])
cor(pcp_pca_0$x[,1:5], pcp_pca_30$x[,1:5])
cor(pcp_pca_0$x[,1:5], pcp_pca_40$x[,1:5])
cor(pcp_pca_0$x[,1:5], pcp_pca_50$x[,1:5])

pcp_pca_30$x[,5] <- -pcp_pca_30$x[,5]
pcp_pca_40$x[,4] <- -pcp_pca_40$x[,4]
pcp_pca_50$x[,2] <- -pcp_pca_50$x[,2]
pcp_pca_50$x[,4] <- -pcp_pca_50$x[,4]
pcp_pca_50$x[,5] <- -pcp_pca_50$x[,5]

pcp_score_norm <- as_tibble(cbind(lod0 = norm((pcp_pca_0$x[,1:5] - pcp_pca_0$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"),
      lod10 = norm((pcp_pca_0$x[,1:5] - pcp_pca_10$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"),
      lod20 = norm((pcp_pca_0$x[,1:5] - pcp_pca_20$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"),
      lod30 = norm((pcp_pca_0$x[,1:5] - pcp_pca_30$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"),
      lod40 = norm((pcp_pca_0$x[,1:5] - pcp_pca_40$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"),
      lod50 = norm((pcp_pca_0$x[,1:5] - pcp_pca_50$x[,1:5]), type = "F")/norm((pcp_pca_0$x[,1:5]), type = "F"))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCP")
```

```{r}
pcp_sdev_norm <- as_tibble(cbind(lod0 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_0$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]),
      lod10 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_10$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]),
      lod20 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_20$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]),
      lod30 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_30$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]),
      lod40 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_40$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]),
      lod50 = norm_vec(pcp_pca_0$sdev[1:5] - pcp_pca_50$sdev[1:5])/norm_vec(pcp_pca_0$sdev[1:5]))) %>% 
  gather(percent_blod, norm) %>% 
  mutate(Method = "PCP")
```
...
round(cbind(Component = 1:27, PCP_0, PCA_0, PCP_50, PCA_50), 4) %>% kable()
round(cbind(Component = 1:27, PCP_0, PCA_0, PCP_50, PCA_50), 4) %>% stargazer::stargazer(., summary = NULL)
```
