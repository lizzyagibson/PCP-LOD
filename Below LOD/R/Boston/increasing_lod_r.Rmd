...
1. Run Jingkai's PCP version on original air pollution data (R).
2. Artificially assign increasing LOD's (10%, 20%, 30%, 40%, and 50% <LOD) to separate test datasets (R).
3. Run Jingkai's PCP version on all 5 <LOD datasets, save L and S matrices from each (R).
...
results_0  <- lod_pcp(as.matrix(mixture_data), 1/sqrt(m), 10, 0)
results_10 <- lod_pcp(mix_data_lod_10,         1/sqrt(m), 10, delta10)
results_20 <- lod_pcp(mix_data_lod_20,         1/sqrt(m), 10, delta20)
results_30 <- lod_pcp(mix_data_lod_30,         1/sqrt(m), 10, delta30)
results_40 <- lod_pcp(mix_data_lod_40,         1/sqrt(m), 10, delta40)
results_50 <- lod_pcp(mix_data_lod_50,         1/sqrt(m), 10, delta50)
