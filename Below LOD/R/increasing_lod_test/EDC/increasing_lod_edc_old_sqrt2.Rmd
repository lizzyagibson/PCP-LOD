...
#pdf("edc_original_lod_sqrt2_Fnorm.pdf")
F_norm %>% ggplot(aes(x = percent_blod, y = norm)) + 
  ...
  labs(x = "Percent Below LOD", y = "Relative Error\n(norm(X-L-S) / norm(X))",
       title = "Original PCP w/ LOD/sqrt(2)")
#dev.off()
...
#pdf("edc_original_lod_sqrt2_LandS.pdf")
...
#pdf("edc_original_lod_sqrt2_singular_vectors.pdf")
...
#pdf("edc_original_lod_sqrt2_singular_vectors_vs_original.pdf")
...
#pdf("edc_original_lod_sqrt2_above_below.pdf")
...
#pdf("edc_original_lod_sqrt2_score_vectors.pdf")
...
#pdf("edc_original_lod_sqrt2_score_vectors_vs_original.pdf")
...
#pdf("edc_original_lod_sqrt2_penalty_sv.pdf")
...
#pdf("edc_original_lod_sqrt2_penalty_sv_vs_original.pdf")
