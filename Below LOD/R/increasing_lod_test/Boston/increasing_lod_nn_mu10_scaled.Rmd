...
V_lod0  <-  svd(L_lod0)$v[,1:4]
V_lod10 <- svd(L_lod10)$v[,1:4]
V_lod20 <- svd(L_lod20)$v[,1:4]
V_lod30 <- svd(L_lod30)$v[,1:4]
V_lod40 <- svd(L_lod40)$v[,1:4]
V_lod50 <- svd(L_lod50)$v[,1:4]
...
as_tibble(V_lod0) %>% 
  ...
  mutate(PM = colnames(mix),
         LOD = "LOD 50")) %>%
  gather(key = singular_vector, value = magnitude, V1:V4) %>%
...
```{r}
# Extract right singular vectors from each low rank solution matrix
nn_V_lod0  <-  svd(nn_L_lod0)$v[,1:4]
nn_V_lod10 <- svd(nn_L_lod10)$v[,1:4]
nn_V_lod20 <- svd(nn_L_lod20)$v[,1:4]
nn_V_lod30 <- svd(nn_L_lod30)$v[,1:4]
nn_V_lod40 <- svd(nn_L_lod40)$v[,1:4]
nn_V_lod50 <- svd(nn_L_lod50)$v[,1:4]
...
```{r}
# Extract right singular vectors from each low rank solution matrix
nn_V_lod0_0  <-  svd(nn_L_lod0_0)$v[,1:4]
nn_V_lod10_0 <- svd(nn_L_lod10_0)$v[,1:4]
nn_V_lod20_0 <- svd(nn_L_lod20_0)$v[,1:4]
nn_V_lod30_0 <- svd(nn_L_lod30_0)$v[,1:4]
nn_V_lod40_0 <- svd(nn_L_lod40_0)$v[,1:4]
nn_V_lod50_0 <- svd(nn_L_lod50_0)$v[,1:4]

# Hack -- flip
nn_V_lod0_0[,3] <- -nn_V_lod0_0[,3]
nn_V_lod50_0[,3] <- -nn_V_lod50_0[,3]
...
```{r}
# Extract right singular vectors from each low rank solution matrix
nn_V_lod0_sqrt2  <-  svd(nn_L_lod0_sqrt2)$v[,1:4]
nn_V_lod10_sqrt2 <- svd(nn_L_lod10_sqrt2)$v[,1:4]
nn_V_lod20_sqrt2 <- svd(nn_L_lod20_sqrt2)$v[,1:4]
nn_V_lod30_sqrt2 <- svd(nn_L_lod30_sqrt2)$v[,1:4]
nn_V_lod40_sqrt2 <- svd(nn_L_lod40_sqrt2)$v[,1:4]
nn_V_lod50_sqrt2 <- svd(nn_L_lod50_sqrt2)$v[,1:4]

# Hack -- flip
nn_V_lod10_sqrt2[,3] <- -nn_V_lod10_sqrt2[,3]
nn_V_lod30_sqrt2[,3] <- -nn_V_lod30_sqrt2[,3]
nn_V_lod0_sqrt2[,4] <- -nn_V_lod0_sqrt2[,4]
...
```{r}
# Extract right singular vectors from each low rank solution matrix
V_lod0_0  <-  svd(L_lod0_0)$v[,1:4]
V_lod10_0 <- svd(L_lod10_0)$v[,1:4]
V_lod20_0 <- svd(L_lod20_0)$v[,1:4]
V_lod30_0 <- svd(L_lod30_0)$v[,1:4]
V_lod40_0 <- svd(L_lod40_0)$v[,1:4]
V_lod50_0 <- svd(L_lod50_0)$v[,1:4]

V_lod30_0[,4] <- -V_lod30_0[,4]
...
```{r}
# Extract right singular vectors from each low rank solution matrix
V_lod0_sqrt2  <-  svd(L_lod0_sqrt2)$v[,1:4]
V_lod10_sqrt2 <- svd(L_lod10_sqrt2)$v[,1:4]
V_lod20_sqrt2 <- svd(L_lod20_sqrt2)$v[,1:4]
V_lod30_sqrt2 <- svd(L_lod30_sqrt2)$v[,1:4]
V_lod40_sqrt2 <- svd(L_lod40_sqrt2)$v[,1:4]
V_lod50_sqrt2 <- svd(L_lod50_sqrt2)$v[,1:4]

V_lod30_sqrt2[,3] <- -V_lod30_sqrt2[,3]
V_lod20_sqrt2[,4] <- -V_lod20_sqrt2[,4]
...
```{r}
u_lod0  <-  svd(L_lod0)$u[,1:4]
u_lod10 <- svd(L_lod10)$u[,1:4]
u_lod20 <- svd(L_lod20)$u[,1:4]
u_lod30 <- svd(L_lod30)$u[,1:4]
u_lod40 <- svd(L_lod40)$u[,1:4]
u_lod50 <- svd(L_lod50)$u[,1:4]
...
```{r}
nn_u_lod0  <-  svd(nn_L_lod0)$u[,1:4]
nn_u_lod10 <- svd(nn_L_lod10)$u[,1:4]
nn_u_lod20 <- svd(nn_L_lod20)$u[,1:4]
nn_u_lod30 <- svd(nn_L_lod30)$u[,1:4]
nn_u_lod40 <- svd(nn_L_lod40)$u[,1:4]
nn_u_lod50 <- svd(nn_L_lod50)$u[,1:4]
...
```{r}
nn_u_lod0_0  <-  svd(nn_L_lod0_0)$u[,1:4]
nn_u_lod10_0 <- svd(nn_L_lod10_0)$u[,1:4]
nn_u_lod20_0 <- svd(nn_L_lod20_0)$u[,1:4]
nn_u_lod30_0 <- svd(nn_L_lod30_0)$u[,1:4]
nn_u_lod40_0 <- svd(nn_L_lod40_0)$u[,1:4]
nn_u_lod50_0 <- svd(nn_L_lod50_0)$u[,1:4]

# Hack -- flip
nn_u_lod0_0[,3] <- -nn_u_lod0_0[,3]
nn_u_lod50_0[,3] <- -nn_u_lod50_0[,3]
...
```{r}
nn_u_lod0_sqrt2  <-  svd(nn_L_lod0_sqrt2)$u[,1:4]
nn_u_lod10_sqrt2 <- svd(nn_L_lod10_sqrt2)$u[,1:4]
nn_u_lod20_sqrt2 <- svd(nn_L_lod20_sqrt2)$u[,1:4]
nn_u_lod30_sqrt2 <- svd(nn_L_lod30_sqrt2)$u[,1:4]
nn_u_lod40_sqrt2 <- svd(nn_L_lod40_sqrt2)$u[,1:4]
nn_u_lod50_sqrt2 <- svd(nn_L_lod50_sqrt2)$u[,1:4]

# Hack -- flip
nn_u_lod10_sqrt2[,3] <- -nn_u_lod10_sqrt2[,3]
nn_u_lod30_sqrt2[,3] <- -nn_u_lod30_sqrt2[,3]
nn_u_lod0_sqrt2[,4] <- -nn_u_lod0_sqrt2[,4]
...
```{r}
u_lod0_0  <-  svd(L_lod0_0)$u[,1:4]
u_lod10_0 <- svd(L_lod10_0)$u[,1:4]
u_lod20_0 <- svd(L_lod20_0)$u[,1:4]
u_lod30_0 <- svd(L_lod30_0)$u[,1:4]
u_lod40_0 <- svd(L_lod40_0)$u[,1:4]
u_lod50_0 <- svd(L_lod50_0)$u[,1:4]

u_lod30_0[,4] <- -u_lod30_0[,4]
...
```{r}
u_lod0_sqrt2  <-  svd(L_lod0_sqrt2)$u[,1:4]
u_lod10_sqrt2 <- svd(L_lod10_sqrt2)$u[,1:4]
u_lod20_sqrt2 <- svd(L_lod20_sqrt2)$u[,1:4]
u_lod30_sqrt2 <- svd(L_lod30_sqrt2)$u[,1:4]
u_lod40_sqrt2 <- svd(L_lod40_sqrt2)$u[,1:4]
u_lod50_sqrt2 <- svd(L_lod50_sqrt2)$u[,1:4]

u_lod30_sqrt2[,3] <- -u_lod30_sqrt2[,3]
u_lod20_sqrt2[,4] <- -u_lod20_sqrt2[,4]
u_lod40_sqrt2[,3] <- -u_lod40_sqrt2[,3]
u_lod40_sqrt2[,4] <- -u_lod40_sqrt2[,4]
...
```{r}
d_lod0  <- svd(L_lod0)$d[1:4]
d_lod10 <- svd(L_lod10)$d[1:4]
d_lod20 <- svd(L_lod20)$d[1:4]
d_lod30 <- svd(L_lod30)$d[1:4]
d_lod40 <- svd(L_lod40)$d[1:4]
d_lod50 <- svd(L_lod50)$d[1:4]
...
```{r}
nn_d_lod0  <- svd(nn_L_lod0)$d[1:4]
nn_d_lod10 <- svd(nn_L_lod10)$d[1:4]
nn_d_lod20 <- svd(nn_L_lod20)$d[1:4]
nn_d_lod30 <- svd(nn_L_lod30)$d[1:4]
nn_d_lod40 <- svd(nn_L_lod40)$d[1:4]
nn_d_lod50 <- svd(nn_L_lod50)$d[1:4]
...
```{r}
nn_d_lod0_0  <- svd(nn_L_lod0_0)$d[1:4]
nn_d_lod10_0 <- svd(nn_L_lod10_0)$d[1:4]
nn_d_lod20_0 <- svd(nn_L_lod20_0)$d[1:4]
nn_d_lod30_0 <- svd(nn_L_lod30_0)$d[1:4]
nn_d_lod40_0 <- svd(nn_L_lod40_0)$d[1:4]
nn_d_lod50_0 <- svd(nn_L_lod50_0)$d[1:4]
...
```{r}
nn_d_lod0_sqrt2  <- svd(nn_L_lod0_sqrt2)$d[1:4]
nn_d_lod10_sqrt2 <- svd(nn_L_lod10_sqrt2)$d[1:4]
nn_d_lod20_sqrt2 <- svd(nn_L_lod20_sqrt2)$d[1:4]
nn_d_lod30_sqrt2 <- svd(nn_L_lod30_sqrt2)$d[1:4]
nn_d_lod40_sqrt2 <- svd(nn_L_lod40_sqrt2)$d[1:4]
nn_d_lod50_sqrt2 <- svd(nn_L_lod50_sqrt2)$d[1:4]
...
```{r}
d_lod0_0  <- svd(L_lod0_0)$d[1:4]
d_lod10_0 <- svd(L_lod10_0)$d[1:4]
d_lod20_0 <- svd(L_lod20_0)$d[1:4]
d_lod30_0 <- svd(L_lod30_0)$d[1:4]
d_lod40_0 <- svd(L_lod40_0)$d[1:4]
d_lod50_0 <- svd(L_lod50_0)$d[1:4]
...
```{r}
d_lod0_sqrt2  <- svd(L_lod0_sqrt2)$d[1:4]
d_lod10_sqrt2 <- svd(L_lod10_sqrt2)$d[1:4]
d_lod20_sqrt2 <- svd(L_lod20_sqrt2)$d[1:4]
d_lod30_sqrt2 <- svd(L_lod30_sqrt2)$d[1:4]
d_lod40_sqrt2 <- svd(L_lod40_sqrt2)$d[1:4]
d_lod50_sqrt2 <- svd(L_lod50_sqrt2)$d[1:4]
